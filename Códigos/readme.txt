...
Todos os outros arquivos que não foram citados são gerados automaticamente pelas rotinas citadas.

DISCLAIMER: Os códigos tiveram como base aqueles fornecidos pelo professor visto que foi dito que não haveria problemas. Entretanto, apenas a base foi utilizada visto que todas as listas pediam informações que precisariam de soluções por mim implementadas.
